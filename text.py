...
digit_to_word_map = {0: "PAD", 1: "One", 2: "Two", 3: "Three", 4: "Four", 5: "Five", 6: "Six", 7: "Seven", 8: "Eight",
                     9: "Nine"}
...
with tf.Session() as sess:
    ...
    for step in range(1000):
        x_batch, y_batch, seqlens_batch = get_sentence_batch(batch_size, train_x, train_y, train_seqlens)
    ...
    for test_batch in range(5):
        x_test, y_test, seqlens_test = get_sentence_batch(batch_size, test_x, test_y, test_seqlens)
